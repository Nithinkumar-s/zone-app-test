...
export const Button = ({ variant='primary', size='md', className='', children, as:Comp='button', ...rest }) => {
  ...
  return <Comp className={`${base} ${sizes[size]} ${variants[variant]} ${className}`} {...rest}>{children}</Comp>;
};
